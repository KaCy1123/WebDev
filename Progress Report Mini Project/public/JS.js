...
function OUTPUT()
{
	...
	Average = parseInt(Course1Grade) + parseInt(Course2Grade) + parseInt(Course3Grade) + parseInt(Course4Grade) + parseInt(Course5Grade) + parseInt(Course6Grade) + parseInt(Course7Grade) + parseInt(Course8Grade) 
	Average = Average/8;
	GPA = Average/100 * 4
	if (GPA >= 3.88){
		LETTER = "A+"
